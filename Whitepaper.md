...
The incumbent derivatives market suffers from large amount of friction. It requires middlemen to provide access to the market, facilitate trades, and lower counterparty risk. This inefficiency creates costs that get passed on to investors. A research paper that covered Stellar based financial derivatives measured the increased efficiency that Stellar based derivatives provide in the following tables. They used revenue per contract to measure costs that get passed to derivative users by central parties in the traditional derivative ecosystem.\ 
...
The formentioned research paper also discussed the live data fees that derivative users pay to central parties in the traditional derivative ecosystem. These fees are another example of the inefficiency and friction in the traditional derivative ecosystem. In a Stellar based derivative ecosystem all data would be public since all transactions would be recorded on the ledger. This would eliminate a significant source of cost and inefficiency. A table showing these fees is pictured below.
...
Tokenized derivatives are essential in the decentralized ledger technology space. Tokenization allows our derivatives to be traded on any cryptocurrency exchange and stored anywhere. A user could write a derivative on our exchange, then transfer it to his Binance Account and sell it on their market. A derivative buyer could take their newly purchased derivative tokens and transfer them to their Ledger Nano S for added security. This flexibility is essential due to the fragmentation/decentralization of the decentralized ledger technology space. It also serves to make our service even less dependant on our organization, and on Stellar's exchange's volume. 
...
- *Proof of ownership*  
The public and collective nature of a decentralized ledger means individuals can't misrepresent what they own on the ledger, including assets and smart contracts. This allows us to easily verify asset ownership and ensure derivatives are set up correctly. The result is that the consumer's need for middlemen to handle counterparty risk is greatly reduced.
...
Stellar has an multi-asset functionality called anchoring that enables users to create custom assets on its ledger and tie them to real-world assets. We use this to create custom assets that allow users to trade their derivatives and write derivatives involving any asset.  
...
### Use Cases:
Optionblox can be used for all of the functions traditional derivatives could be used for such as investment and risk management. It will preform these basic functions more efficiently than incumbent systems due to the friction reduction we discussed previously. We will discuss a few use cases that highlight the flexibility and accessability of our system. 

1. **Cryptocurrency Investment Hedging:**  
A primary concern for cryptocurrency holders is volatility. OptionBlox enables users to utilize financial derivatives to hedge against cryptocurrency volatility. Optionblox's capability of supporting any asset pairing means that it supports a much wider range of cryptocurrencies. In addition, our extreme efficiency means we will have lower fees than competitors, and our accessibility means we should have better spreads.

   Latera is an investor. He beleives in Stellar's future and wants to hold XLM. However, the volatility of cryptocurrency is a major deterrent. He comes across a tool called OptionBlox that allows him to enter into an options contract guaranteeing him the option to sell 100xlm for $7.00 in 1 year's time. This hedges him against any potential downward movement by XLM. He purchases a large batch of these contracts and enters into his XLM investment.

2. **OTC Derivatives in Developing Countries:**  
OTC derivatives are very useful for all businesses. However, in order to enter an OTC derivative contract, the interested party must find a counterparty and central party to facilitate the derivative. This creates significant issues for unsophisticated parties lacking relationships with these entities. [A recent paper published by the IMF](https://www.elibrary.imf.org/view/IMF001/25871-9781498303774/25871-9781498303774/25871-9781498303774_A001.xml?redirect=true) found that the OTC derivative market suffers from significant price discrimination. Unsophisticated parties lack market accessibility, and as a result, they pay much larger spreads than sophisticated parties. Optionblox solves this problem by removing central parties from the equation, and by enabling derivative trading on an distributed ledger. This makes it much easier for unsophisticated parties to find a counterparty, and eliminates their need to find a central party. 

   Adam is a citizen and resident of Vietnam. He owns a clothing factory and most of his revenue is received in USD. However, most of his expenses are paid in Vietnamese Dong(VND). He would like to insulate himself against exchange rate fluctuations by entering an OTC USD:VND future. However, he is not a large enough client to have connections with foreign banks or central parties in the derivative markets. To make things more difficult, foreign currency exchange is illegal in Vietnam. Adam finds out about OptionBlox and realizes it is the answer to his problems. Using OptionBlox, he enters into an OTC USD:VND future with a western bank that also wants to insulate themselves against exchange rate fluctuations. Because he did not have to find a central party, and had access to a wide range of counterparties, the spread he payed using OptionBlox was small. The distributed nature of the application also allowed him to circumvent local currency controls.
...
We do not want to serve as custodian for users keys due to the risks this entails. Instead we will use Stellar's SEP-0007 to send transaction envelopes to users who can then add their signature in a trusted application or exchange.
